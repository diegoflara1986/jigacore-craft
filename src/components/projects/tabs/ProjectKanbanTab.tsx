    ...
    return (
      ...
      >
        <div className="flex items-center justify-between mb-3 px-1">
          ...
          {!isArchived && (
            <Button size="icon" variant="ghost" className="h-5 w-5" onClick={() => guardAction("kanban", "move_cards", "agregar una historia al tablero", () => { setQuickAddCol(col.id); setQuickAddTitle(""); })}>
