...
export const PERMISSION_MODULES = [
  ...
  { module: "sig_form_001", label: "Incidentes de seguridad", icon: "🛡️",
    group: "SIG / Formularios",
    actions: [
      { action: "ver", label: "Ver registros de formulario" },
      { action: "registrar", label: "Registrar formulario" },
      { action: "editar", label: "Editar registro" },
      { action: "duplicar", label: "Duplicar registro" },
      { action: "eliminar", label: "Eliminar registro" },
    ]
  },
  { module: "sig_form_002", label: "Solicitar accesos (FOR-SGSI-002)", icon: "🔑",
    group: "SIG / Accesos y usuarios",
    actions: [
      { action: "ver", label: "Ver registros de formulario" },
      { action: "registrar", label: "Registrar formulario" },
      { action: "editar", label: "Editar registro" },
  ...
  { module: "sig_form_003", label: "Gestionar alta/baja usuarios (FOR-SGSI-003)", icon: "👤",
    group: "SIG / Accesos y usuarios",
    actions: [
      { action: "ver", label: "Ver registros de formulario" },
      { action: "registrar", label: "Registrar formulario" },
  ...
  { module: "sig_form_004", label: "Aprobación de cambios (FOR-SGSI-004)", icon: "🔄",
    group: "SIG / Solicitud de cambios",
    actions: [
      { action: "ver", label: "Ver registros de formulario" },
      { action: "registrar", label: "Registrar formulario" },
      { action: "editar", label: "Editar registro" },
  ...
  { module: "sig_form_006", label: "Asignación y devolución de activos (FOR-SGSI-006)", icon: "💻",
    group: "SIG / Solicitud de cambios",
    actions: [
      { action: "ver", label: "Ver registros de formulario" },
      { action: "registrar", label: "Registrar formulario" },
  ...
  { module: "sig_reg_001", label: "Registro de capacitaciones (REG-SGSI-001)", icon: "📚",
    group: "SIG / Capacitación y mejoras",
    actions: [
      { action: "ver", label: "Ver registros de formulario" },
      { action: "registrar", label: "Registrar formulario" },
      { action: "editar", label: "Editar registro" },
  ...
  { module: "sig_reg_002", label: "Acciones correctivas (REG-SGSI-002)", icon: "✅",
    group: "SIG / Capacitación y mejoras",
    actions: [
      { action: "ver", label: "Ver registros de formulario" },
      { action: "registrar", label: "Registrar formulario" },
